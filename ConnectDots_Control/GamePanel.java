...
public class GamePanel extends JPanel {
    ...
    public static void main(String[] args) {
        ...
        stage.ArduinoRead(MySerialPort,stage);
    ...
    public void ArduinoRead(SerialPort MySerialPort, GamePanel stage){
        ...
        try 
      	{
   			while (true)
   			{
                ...
                if (S.equals("Izquierda") || S.equals("Derecha") || S.equals("Arriba") || S.equals("Abajo")) {
                    ...
                    stage.test(S, MySerialPort, stage); // Llama a test solo para comandos válidos
                } else {
    ...
    //@Override
    public void test(String f,SerialPort MySerialPort, GamePanel stage) {
        ...
        if (f.equals("Enter")) {
            ...
            if (f.equals("Izquierda") && currentCol > 0) {
                newCol--;
